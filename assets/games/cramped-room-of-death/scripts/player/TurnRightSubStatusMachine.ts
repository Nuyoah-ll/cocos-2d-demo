...
const BASE_URL = "cramped-room-of-death/texture/player/turnright"

export class TurnRightSubStatusMachine extends DirectionStatusMachine {
  constructor(fsm: StatusMachine) {
    super(fsm);
    // 在TurnRight子状态下，向着top方向转向的动画，其他方向同理
